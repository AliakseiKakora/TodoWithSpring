...
public class TaskSqlQueryHolder implements CrudJdbcSqlQueryHolder {
    ...
    private static final String GET_BY_ID_SQL = "select t.id, t.name, t.description, t.date_added, t.date_completion, t.completed," +
           " t.deleted, fi.id as file_id, fi.path from tasks t left join files_info fi on fi.task_id = t.id where t.id = ?";
    private static final String GET_ALL_SQL = "select t.id, t.name, t.description, t.date_added, t.date_completion, t.completed," +
