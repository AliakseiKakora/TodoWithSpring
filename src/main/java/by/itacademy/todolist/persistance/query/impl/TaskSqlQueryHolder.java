...
public class TaskSqlQueryHolder implements CrudJdbcSqlQueryHolder {
    ...
    private static final String GET_BY_ID_SQL = "select id, description, date_added, date_completion, completed, deleted from tasks where id = ?";
    private static final String GET_ALL_SQL = "select id, description, date_added, date_completion, completed, deleted from tasks";
